...
$("button#GenerateReport").click( function() {
	...
	var i;
	for( i= 0 ; i<sels.length; i++ ) {
		param['ch'+i] = $("select[name='"+sels[i]+"cam']").val();
...
$("select.cam").change(function(){
	...
	$("#"+cam+"slider").slider("option","max",len*30);
	$("#"+cam+"slider").slider("value",len*15);
});
...
<p class="btset">
<input href="dashboardmorning.php" name="btset" id="btmorning" checked="checked"
...
<p>Notes:</p>
<textarea name="notes" style="margin: 2px; width: 180px; height: 80px;"></textarea>
...
<table border="0" cellpadding="2" cellspacing="4" style="width:500px">
	<tbody>
		<tr>
			<td>
			<img width="360" alt="" name="lpr1img" src="res/247logo.jpg" /><br/>
			<div class="slider" id="lpr1slider" name="lpr1slider" style="max-width:360"></div>
			<div>LPR1:&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
			...
			&nbsp; &nbsp;&nbsp;&nbsp;<span id="lpr1time">0:00</span>
			</div>
			</td>
			
			<td>
			<img width="360" alt="" name="lpr2img" src="res/247logo.jpg" /><br/>
			<div class="slider" id="lpr2slider" name="lpr2slider" style="max-width:360px"></div>
			<div>LPR2:&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
			...
			&nbsp; &nbsp;&nbsp;&nbsp;<span id="lpr2time">0:00</span>
			</div>
			</td>
			
			<td>
			<video id="avivideo" width="360" height="240" src="" type="video/mp4" controls>Your browser does not support the video tag.</video>
			<div>Video:&nbsp; &nbsp;&nbsp;&nbsp;
		...
		<tr>
			<td>
			<img width="360" alt="" name="ov1img" src="res/247logo.jpg" /><br/>
			<div class="slider" id="ov1slider" name="ov1slider" style="max-width:360"></div>
			<div>OV1:&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
			...
			&nbsp; &nbsp;&nbsp;&nbsp;<span id="ov1time">0:00</span>
			</div>
			</td>
			
			<td>
			<img width="360" alt="" name="ov2img" src="res/247logo.jpg" /><br/>
			<div class="slider" id="ov2slider" name="ov2slider" style="max-width:360px"></div>
			<div>OV2:&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
