...
<?php if( !empty($support_viewtrack_logo) ){ ?>
	<img alt="index.php" src="res/side-VT-logo-clear.png" /><br>
<?php } else if( !empty($support_fleetmonitor_logo) ){ ?>
	<img alt="index.php" src="res/side-FM-logo-clear.png" /><br>
<?php } else { ?> 
	<img alt="index.php" src="res/side-TD-logo-clear.png" /><br>
<?php } ?>
...
<p style="text-align: center;">
	<a href="http://www.247securityinc.com/"><img src="res/247-Logo-Small.png" alt="247Security Inc."/></a>
</p> 
